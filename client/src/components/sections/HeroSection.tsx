    ...
    >
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 max-w-7xl mx-auto relative z-10 pt-24 pb-16 md:py-24 lg:py-28 box-border">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full min-w-0">
          ...
          >
            {/* Badge for both mobile and desktop */}
            <motion.div 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-md mx-auto lg:mx-0">
                <Link 
                  ...
                  className={getMicroInteractionClasses(
                    ...
                    "group glass-effect border-transparent hover:border-primary/20 text-text-primary hover:text-primary px-6 py-3.5 rounded-xl transition-all duration-300 text-center font-medium flex items-center justify-center w-full shadow-sm hover:shadow-md micro-lift micro-ripple",
                    {
                      hover: "micro-scale",
                      active: "micro-click"
                    }
                  )}
                  {...getMicroInteractionProps(secondaryButtonHandlers)}
                >
      ...
      >
        <div 
          className={getMicroInteractionClasses(
            ...
            "flex flex-col items-center micro-hover micro-pulse",
            {
              hover: "micro-scale",
              active: "micro-click"
            }
